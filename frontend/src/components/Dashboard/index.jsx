...
export default function Dashboard() {
    ...
    // authController.js's publicUser() returns { id, name, email, role } —
    // this used to check user?.username (a field that doesn't exist on that
    // shape), which is why "Guest" always showed even when logged in.
    ...
    const sidebarContent = (
        <>
            ...
            <div className="sidebar-foot">
                ...
                <span className="live-tag" style={{ marginBottom: "10px", alignSelf: "flex-start" }}>
        ...
        <div className="dash-root">
            ...
            <main className="main">
                ...
                <DashboardHero
                    ...
                    lastScan={dashboard ? timeAgo(dashboard.lastScanAt) : "—"}
                    score={dashboard?.latestScore}
                    findings={dashboard?.openFindings}
                    assetsMonitored={dashboard?.assetsMonitored}
                    totalScans={dashboard?.totalScans}
                    latestScanId={dashboard?.latestScanId}
                />
                ...
                <QuickActions latestScanId={dashboard?.latestScanId} />
            </main>
        </div>
    );
}
